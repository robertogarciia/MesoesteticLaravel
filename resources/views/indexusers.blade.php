...
.btn-danger {
    ...
    background: linear-gradient(356deg, rgba(191, 191, 191, 1) 0%, rgba(255, 0, 0, 1) 100%);
}
...
.btn-primary {
    background: rgb(78, 88, 255);
    background: linear-gradient(356deg, rgba(78, 88, 255, 1) 0%, rgba(0, 185, 255, 1) 100%);
}
    ...
    <div class="d-flex justify-content-between align-items-center my-2">
        ...
        <form method="GET" action="{{ route('users.index') }}" class="mb-4">
            <div class="d-flex justify-content-end">
                <div class="dropdown me-2"> <button class="btn-d btn-lg btn-info mt-4 dropdown-toggle" type="button"
                        id="dropdownMenuUserType" data-bs-toggle="dropdown" aria-expanded="false">
                        Tipo de usuario
                    </button>
                ...
                <div class="dropdown">
                    <button class="btn-d btn-lg btn-secondary mt-4 ml-3 dropdown-toggle" type="button"
        ...
        <a href="{{ route('users.create') }}" class="btn-d btn-success btn-lg" style="margin-right: 20px;">Crear
            Usuario</a>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="{{ route('users.edit', $usuario->id) }}" class="btn btn-primary btn-lg"
                        ...
                        <form action="{{ route('users.destroy', $usuario->id) }}" method="POST"
                            ...
                            <button type="submit" class="btn btn-danger btn-lg"
                                onclick="return confirm('¿Estás seguro de que quieres eliminar este usuario?')">Borrar</button>
                        </form>
                    </td>
                </tr>
                @endforeach
