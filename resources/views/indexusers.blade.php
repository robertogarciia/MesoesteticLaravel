...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <!-- Per adaptar-se a diferents mides de pantalla -->
        <table class="table">
            <!-- Taula amb cantonades arrodonides -->
            <thead class="bg-light">
                <!-- Encapçalaments destacats -->
                <tr>
                    <th>ID</th>
                    <th>Correu</th>
                    <th>Càrrec</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if (str_contains($usuari->email, '@admin.com'))
                        Admin
                        @else
                        Usuari
                        @endif
                    ...
                    <td>
                        <!-- Accions per a cada usuari -->
                        <a href="{{ route('users.edit', $usuari->id) }}" class="btn btn-primary btn-lg"
                            style="margin-right: 5px;">
                            Editar
                        </a>
                        <form action="{{ route('users.destroy', $usuari->id) }}" method="POST"
